  ...
  <Model v-model="active">
    ...
    <div class="modal-body">
      ...
      <template v-else class="search-folder mb-0">
        ...
        <template v-if="privateCustomizationAllowed">
          <div
          ...
          >
            <p>
              ...
              <span
                ...
                >Selected folder contains private assets, which are available
          ...
          <div v-if="shareMessage" class="notes">
            <p>
              <strong>Note : </strong>Selection contains private assets, which
